...
for elemento in dias:
    ...
    mes = elemento[4:6]
    dia = elemento[6:8]
    print("Inicio del dia: " + elemento)
    print("año: " + ano + " mes: " + mes + " dia: " + dia)
    for object in objects:
        if object.find(elemento) != -1:
            ...
            df = (
                ...
                .withColumn(
                    "update_ts_dms",
                    f.concat(lit(objects_time[i]), f.lpad(col("i"), 6, "0")),
                )
            ...
            df.repartition(1).write.mode("append").parquet(
                target + "/" + "year=" + ano + "/month=" + mes + "/day=" + dia
            )
