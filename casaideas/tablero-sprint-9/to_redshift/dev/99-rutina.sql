...
CREATE TABLE dev.fct_ventas_tmp AS
...
SELECT
    ...
    ,a_l
    ,precio_calculado
FROM dev.fct_ventas_tmp;


DROP TABLE IF EXISTS dev.fct_ventas_tmp;
DROP TABLE IF EXISTS dev.fct_ventas_dev